...
public class UsingAnimals {
    //
    private static String jmh_absolute_path =
        "/Users/hufflen/texts/teaching/SL-L3/2021/JRuby/jruby-plus-2021.rb" ;
    //
	...
	if (args.length == 0) {
	    ...
	    container.runScriptlet(PathType.ABSOLUTE,jmh_absolute_path) ;
